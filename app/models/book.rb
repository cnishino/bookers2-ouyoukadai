class Book < ApplicationRecord
  ...
  scope :created_2day_ago, -> { where(created_at: 2.day.ago.all_day)} #2日前の投稿数
  scope :created_3day_ago, -> { where(created_at: 3.day.ago.all_day)} #3日前の投稿数
  scope :created_4day_ago, -> { where(created_at: 4.day.ago.all_day)} #4日前の投稿数
  scope :created_5day_ago, -> { where(created_at: 5.day.ago.all_day)} #5日前の投稿数
  scope :created_6day_ago, -> { where(created_at: 6.day.ago.all_day)} #6日前の投稿数
